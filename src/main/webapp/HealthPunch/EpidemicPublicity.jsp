...
<nav>
    <ul>
        <li><img src="Picture/img1.jpg" alt=""></li>
        <li><img src="Picture/img2.jpg" alt=""></li>
        <li><img src="Picture/img3.jpg" alt=""></li>
        <li><img src="Picture/img4.jpg" alt=""></li>
        <li><img src="Picture/img1.jpg" alt=""></li>
        <li><img src="Picture/img2.jpg" alt=""></li>
        <li><img src="Picture/img3.jpg" alt=""></li>
        <li><img src="Picture/img4.jpg" alt=""></li>
...
<a href="input.jsp" class="button button1"
   style="position: absolute;left: 950px;top: 500px">健康打卡</a>
</body>
</html>
